...
import edu.uci.ics.sourcerer.tools.java.utilization.repo.ArtifactRepositoryBuilder;
...
public class RepositoryGenerator {
  ...
  public static final ArtifactRepository generateArtifactRepository() {
    ...
    try {
      ...
      return ArtifactRepositoryBuilder.buildRepository(jars, clusters);
    } finally {
      task.finish();
    }
  }
