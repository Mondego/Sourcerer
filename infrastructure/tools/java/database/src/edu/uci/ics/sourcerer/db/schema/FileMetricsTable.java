 ...
 */
public class FileMetricsTable extends DatabaseTable {
  public static final String TABLE = "file_metrics";
  
  public FileMetricsTable(QueryExecutor executor, TableLocker locker) {
