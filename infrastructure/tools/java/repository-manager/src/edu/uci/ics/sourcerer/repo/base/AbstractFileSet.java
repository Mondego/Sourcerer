...
//  private File cache;
//  
//  private Collection<IJar> jarFiles;
//  
...
//        jarFiles = reader.deserializeToCollection(IJar.class);
//        uniqueFiles = reader.deserializeToCollection(IJavaFile.class);
//        bestDuplicateFiles = reader.deserializeToCollection(IJavaFile.class);
...
//  
//  protected final void addJarFile(IJar file) {
//    jarFiles.add(file);
//  }
//  
...
//  
//  @Override
//  public final Iterable<IJar> getJarFiles() {
//    return jarFiles;
//  }
//  
...
//      writer.serialize(jarFiles);
//      writer.serialize(uniqueFiles);
//      writer.serialize(bestDuplicateFiles);
//      writer.serialize(fileCount);
//      writer.serialize(discardedDuplicateCount);
//    } catch (IOException e) {
