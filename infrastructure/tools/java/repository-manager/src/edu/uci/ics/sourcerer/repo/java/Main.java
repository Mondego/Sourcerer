...
//        ParametrizedRepository repo = ParametrizedRepository.getRepository(INPUT_REPO.getValue(), FileUtils.getTempDir());
...
//      protected void action() {
//        ParametrizedRepository repo = ParametrizedRepository.getRepository(INPUT_REPO.getValue());
//        repo.createJarIndex();
//      }
...
//        ParametrizedRepository.migrateRepository(INPUT_REPO.getValue(), OUTPUT_REPO.getValue(), completed);
//      }
...
//      protected void action() {
//        ParametrizedRepository.getRepository(INPUT_REPO.getValue()).getJarIndex().cleanManifestFiles();
//      }
//    }.setProperties(INPUT_REPO, JARS_DIR, JAR_INDEX_FILE);
//  
