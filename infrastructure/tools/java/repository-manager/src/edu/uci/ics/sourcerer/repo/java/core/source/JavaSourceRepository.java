...
public class JavaSourceRepository extends AbstractRepository<JavaSourceProject> {
  ...
  protected final RepoFile jarsRoot;
  protected final RepoFile projectJarsRoot;
  protected final RepoFile mavenJarsRoot;
  ...
  public static JavaSourceRepository make() {
    ...
    return new JavaSourceRepository(RepoFile.makeRoot(INPUT_REPO));
  }
  
  @Override
  protected JavaSourceProject createProject(ProjectLocation loc) {
