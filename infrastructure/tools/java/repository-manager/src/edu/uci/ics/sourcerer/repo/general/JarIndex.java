...
////  }
//  
//  public static void aggregateJars(ParametrizedRepository repo) {
...
//          
//          for (IJar jar : fileSet.getJarFiles()) {
...
//  }
//  
//  public static void createJarIndexFile(ParametrizedRepository repo) {
//    Set<String> completed = Logging.initializeResumeLogger();
//    
