...
//import edu.uci.ics.sourcerer.tools.java.extractor.eclipse.ReferenceExtractorVisitor;
...
//    ReferenceExtractorVisitor visitor = new ReferenceExtractorVisitor(bundle);
//    MissingTypeWriter missingTypeWriter = bundle.getMissingTypeWriter();
//    
...
//  private boolean checkForMissingTypes(CompilationUnit unit, SourceExtractionReport report, MissingTypeWriter writer) {
