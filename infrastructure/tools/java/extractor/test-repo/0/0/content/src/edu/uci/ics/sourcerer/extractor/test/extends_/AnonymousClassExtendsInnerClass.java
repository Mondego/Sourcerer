...
// CLASS *pkg*.AnonymousClassExtendsInnerClass
// INSIDE *pkg*.AnonymousClassExtendsInnerClass *pkg*

// CONSTRUCTOR *pkg*.AnonymousClassExtendsInnerClass.<init>()
...
// METHOD *pkg*.AnonymousClassExtendsInnerClass.method()
...
// USES *pkg*.AnonymousClassExtendsInnerClass.method() *pkg*.InnerClassExtended InnerClassExtended
// USES *pkg*.AnonymousClassExtendsInnerClass.method() *pkg*.InnerClassExtended$Inner Inner
...
// EXTENDS *pkg*.AnonymousClassExtendsInnerClass$anonymous-1 *pkg*.InnerClassExtended$Inner InnerClassExtended.Inner
...
// CALLS *pkg*.AnonymousClassExtendsInnerClass$anonymous-1.<init>() *pkg*.InnerClassExtended$Inner.<init>() -
package edu.uci.ics.sourcerer.extractor.test.extends_;

public class AnonymousClassExtendsInnerClass {
  public void method() {
    new InnerClassExtended.Inner() {};
  }
}
