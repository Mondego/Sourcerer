...
// CLASS *pkg*.LocalClassImplementsInnerInterface
// INSIDE *pkg*.LocalClassImplementsInnerInterface *pkg*

// CONSTRUCTOR *pkg*.LocalClassImplementsInnerInterface.<init>()
...
// METHOD *pkg*.LocalClassImplementsInnerInterface.method()
...
// CLASS *pkg*.LocalClassImplementsInnerInterface$local-1-Local
// INSIDE *pkg*.LocalClassImplementsInnerInterface$local-1-Local *pkg*.LocalClassImplementsInnerInterface.method()
// IMPLEMENTS *pkg*.LocalClassImplementsInnerInterface$local-1-Local *pkg*.InnerInterfaceToImplement$Inner InnerInterfaceToImplement.Inner
// USES *pkg*.LocalClassImplementsInnerInterface$local-1-Local *pkg*.InnerInterfaceToImplement$Inner Inner
// USES *pkg*.LocalClassImplementsInnerInterface$local-1-Local *pkg*.InnerInterfaceToImplement InnerInterfaceToImplement
...
public class LocalClassImplementsInnerInterface {
  public void method() {
    class Local implements InnerInterfaceToImplement.Inner {}
  }
}
