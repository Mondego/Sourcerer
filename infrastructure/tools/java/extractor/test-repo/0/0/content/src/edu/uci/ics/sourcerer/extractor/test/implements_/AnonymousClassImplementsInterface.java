...
// CLASS *pkg*.AnonymousClassImplementsInterface
// INSIDE *pkg*.AnonymousClassImplementsInterface *pkg*

// CONSTRUCTOR *pkg*.AnonymousClassImplementsInterface.<init>()
...
// METHOD *pkg*.AnonymousClassImplementsInterface.method()
...
// USES *pkg*.AnonymousClassImplementsInterface.method() *pkg*.InterfaceToImplement InterfaceToImplement
...
// IMPLEMENTS *pkg*.AnonymousClassImplementsInterface$anonymous-1 *pkg*.InterfaceToImplement InterfaceToImplement
