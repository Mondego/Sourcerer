...
// CLASS *pkg*.LocalClassExtendsLocalClass
// INSIDE *pkg*.LocalClassExtendsLocalClass *pkg*

// CONSTRUCTOR *pkg*.LocalClassExtendsLocalClass.<init>()
...
// METHOD *pkg*.LocalClassExtendsLocalClass.method()
...
// CLASS *pkg*.LocalClassExtendsLocalClass$local-1-Extended
...
// CLASS *pkg*.LocalClassExtendsLocalClass$local-2-Local
