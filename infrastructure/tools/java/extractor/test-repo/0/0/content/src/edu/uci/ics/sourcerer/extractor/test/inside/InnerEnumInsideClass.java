...
// CLASS *pkg*.InnerEnumInsideClass
// CONSTRUCTOR *pkg*.InnerEnumInsideClass.<init>()
// ENUM *pkg*.InnerEnumInsideClass$Inner
// CONSTRUCTOR *pkg*.InnerEnumInsideClass$Inner.<init>()
