...
public class CodeGenieIndexBuilder extends AbstractIndexBuilder {
  ...
  protected void index() throws SolrServerException, IOException {
    ...
    try (SelectQuery selectMethods = exec.createSelectQuery(EntitiesTable.ENTITY_ID.qualify(e1).compareEquals(RelationsTable.LHS_EID), RelationsTable.RHS_EID.compareEquals(EntitiesTable.ENTITY_ID.qualify(e2)))) {
      ...
      while (result.next()) {
        ...
        doc.addField("param_count", Integer.valueOf(0));
