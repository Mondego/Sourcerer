...
import edu.uci.ics.sourcerer.repo.core.BatchProperties;
 ...
 */
final class Batch <Project extends RepoProject> implements IModifiableBatch<Project> {
  ...
  protected Batch(AbstractRepository<Project> repo, RepoFile dir, Integer batch) {
    this.repo = repo;
    this.dir = dir;
    this.batch = batch;
  ...
  protected Project add(Integer checkout) {
    Project project = repo.createProject(new ProjectLocation(batch, checkout, dir.getChild(checkout.toString())));
