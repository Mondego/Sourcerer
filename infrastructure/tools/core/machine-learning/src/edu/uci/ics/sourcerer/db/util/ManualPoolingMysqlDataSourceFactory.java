 ...
 * 
 */
public class ManualPoolingMysqlDataSourceFactory {
	// jdbc:mysql://tagus.ics.uci.edu:3306/sourcerer
	final public static String DB_URI = "jdbc:mysql://mondego.calit2.uci.edu:3307/sourcerer_test";
//	public static String USERNAME = "sourcerer";
//	public static String PASSWORD = "";
	...
	public static void main(String[] args) {
		...
		DataSource dataSource = getDataSource(args[0], args[2], args[3]);
		System.out.println("Done.");
...
// -classpath
// commons-pool-1.5.4.jar:commons-dbcp-1.2.2.jar:j2ee.jar:oracle-jdbc.jar:. \
