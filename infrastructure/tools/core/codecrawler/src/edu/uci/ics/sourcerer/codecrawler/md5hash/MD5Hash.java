 ...
 * April 13, 2006 - Huy - Added method to fully digest an InputStream.
 */
public class MD5Hash implements WritableComparable {
  ...
  /**
   * Construct a hash value for a DataInput.
   * @author Huy A. Huynh
   */
  public static MD5Hash digest(InputStream input) throws IOException {
	  int bytesRead;
	  synchronized (DIGESTER) {
