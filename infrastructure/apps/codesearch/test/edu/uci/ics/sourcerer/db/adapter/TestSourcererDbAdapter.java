...
public class TestSourcererDbAdapter extends TestCase {
	...
	public void testDbAdapterForERTables(){
		ERTables er = dba.buildDbForHitEntities(Arrays.asList(hitEids3));
		
		er.buildIndices();
		
		List<String> jdkFqns =  er.getJdkFqnsUsedByEntityId("1483927");
		assertNotNull(jdkFqns);
		
		for(String s: jdkFqns){
			System.out.println(s);
		}
		
//		List<String> eIds = er.getEntiyIdsUsingFqns(null, jdkFqns);
//		assertNotNull(eIds);
//		for(String s: eIds){
//			System.out.println(s);
//		}
