...
//			throw new IllegalArgumentException("only jdk or lib");
	...
	private static Document getDocumentFromString(String xmlResultInString){
		InputSource input = new InputSource(new StringReader(xmlResultInString));
