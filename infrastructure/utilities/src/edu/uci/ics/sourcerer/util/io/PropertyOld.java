...
public enum PropertyOld {
  ...
  private PropertyOld(String name) {
    this.name = name;
  }
  
  private PropertyOld(String name, String defaultValue) {
    this.name = name;
    this.defaultValue = defaultValue;
    this.hasDefaultValue = true;
  }
  
  private PropertyOld(String name, boolean isFlag) {
    this.name = name;
    this.isFlag = isFlag;
  }
  ...
  public static PropertyOld parse(String s) {
    for (PropertyOld prop : values()) {
