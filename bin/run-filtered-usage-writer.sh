...
# --output /Users/shoeseal/sandbox/Sourcerer/infrastructure/tools/core/machine-learning/output.test --input /Users/shoeseal/sandbox/Sourcerer/infrastructure/tools/core/machine-learning/output.test --min-apis 1 --min-entities 8 